...
def print_header():
    ...
    st.write("Disponibilized by Mark Newman at:\n"+
...
def search_by_label():
    ...
    if search_option == "Indexes (recommended)":
        st.write("Vertex are in ther interval 0-296")
        by_label = False
    else:
        st.write("Vertex are in ther interval 1-306 (some aren't in the database)")
        by_label = True
